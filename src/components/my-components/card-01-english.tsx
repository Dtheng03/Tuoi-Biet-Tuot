...
export default function Card01English() {
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="absolute bg-[#FFEB84] h-[105px] w-[246px] rounded-tl-xl">
                        <img className="h-full w-full object-contain" src="/pic-1-eng.png" alt="Cau 1" />
                    </div>
                </div>

                <p className="mt-[108px] text-center text-[#131B63] italic text-[15px] font-medium tracking-tight">
                    Causes of Tooth Decay, Bad Breath and How to Fix Them
                </p>
            </div>
            <Dialog
                open={open}
