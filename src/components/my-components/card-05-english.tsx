...
export default function Card05English() {
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="absolute bg-[#FFFBE1] h-[105px] w-[246px] rounded-tl-xl">
                        <img className="h-full w-full object-contain" src="/pic-5-eng.png" alt="Cau 5" />
                    </div>
                </div>

                <p className="mt-[110px] text-center text-[#131B63] italic text-[13px] font-medium tracking-tighter overflow-hidden">
                    Are dental floss and water flossers truly necessary for daily oral hygiene maintenance?
                </p>
            </div>
            <Dialog
                open={open}
