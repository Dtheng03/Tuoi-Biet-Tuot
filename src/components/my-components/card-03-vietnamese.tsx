...
export default function Card03Vietnamese() {
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="absolute bg-[#5586FD] h-[105px] w-[246px] rounded-tl-xl">
                        <img className="h-full w-full object-contain" src="/pic-3-viet.png" alt="Cau 3" />
                    </div>
                </div>

                <p className="mt-[108px] text-center text-[#131B63] italic text-[15px] font-medium tracking-tight">
                    Có nên sử dụng những sản phẩm làm trắng răng hay không?
                </p>
            </div>
            <Dialog
                open={open}
