...
export default function Card06English() {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="absolute bg-[#FFEB84] h-[105px] w-[246px] rounded-tl-xl">
                        <img className="h-full w-full object-cover" src="/pic-6-eng.png" alt="Cau 6" />
                    </div>
                </div>

                <p className="mt-[115px] text-center text-[#131B63] italic text-[15px] font-medium tracking-tight">
                    Effective Management of Gingivitis
                </p>
            </div>
            <Dialog
                open={open}
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Effective Management of Gingivitis</DialogTitle>
                    </DialogHeader>
                    <iframe
                        src="https://www.youtube.com/embed/NfgZ0aq9ea0" // Bắt buộc mute để autoplay
