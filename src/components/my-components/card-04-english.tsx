...
export default function Card04English() {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="absolute bg-[#FFEB84] h-[105px] w-[246px] rounded-tl-xl">
                        <img className="h-full w-full object-contain" src="/pic-4-eng.png" alt="Cau 4" />
                    </div>
                </div>

                <p className="mt-[108px] text-center text-[#131B63] italic text-[15px] font-medium tracking-tight">
                    What are the causes and remedies for white tongue?
                </p>
            </div>
            <Dialog
                open={open}
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>What are the causes and remedies for white tongue?</DialogTitle>
                    </DialogHeader>
                    <iframe
                        src="https://www.youtube.com/embed/AbfFbt-nolY" // Bắt buộc mute để autoplay
