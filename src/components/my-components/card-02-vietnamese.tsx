...
export default function Card02Vietnamese() {
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="absolute bg-[#FFFBE1] h-[105px] w-[246px] rounded-tl-xl">
                        <img className="h-full w-full object-contain" src="/pic-2-viet.png" alt="Cau 2" />
                    </div>
                </div>

                <p className="mt-[108px] text-center text-[#131B63] italic text-[15px] font-medium tracking-tight">
                    Những phương pháp hiệu quả để cải thiện tình trạng răng xỉn màu
                </p>
            </div>
            <Dialog
                open={open}
