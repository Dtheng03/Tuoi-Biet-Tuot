...
export default function Card07English() {
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="absolute bg-[#FFFBE1] h-[105px] w-[246px] rounded-tl-xl">
                        <img className="h-full w-full object-contain" src="/pic-7-eng.png" alt="Cau 7" />
                    </div>
                </div>

                <p className="mt-[108px] text-center text-[#131B63] italic text-[15px] font-medium tracking-tight">
                    Effective treatment when wisdom teeth cause pain and swelling
                </p>
            </div>
            <Dialog
                open={open}
