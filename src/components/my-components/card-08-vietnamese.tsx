...
export default function Card08Vietnamese() {
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="absolute bg-[#5586FD] h-[105px] w-[246px] rounded-tl-xl">
                        <img className="h-full w-full object-contain" src="/pic-8-viet.png" alt="Cau 8" />
                    </div>
                </div>

                <p className="mt-[108px] text-center text-[#131B63] italic text-[15px] font-medium tracking-tight">
                    Tác hại do thói quen nghiến răng, nhai đá, dùng răng mở nắp chai
                </p>
            </div>
            <Dialog
                open={open}
